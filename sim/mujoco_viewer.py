...
class MujocoViewer():
    def __init__(self,
        ...
        self._showinfo = True
        self._show_tasks_skills_menu = False
        self._framenum = 0
        ...
        with self._gui_lock:
            ...
            if self._showinfo:
                ...
                if self._slowmotion:
                    ...
                    str_slow = ""
                hours, minutes, seconds = self.seconds_to_hms(self.data.time)
                ...
                mj.mjr_overlay(mj.mjtFontScale.mjFONTSCALE_150.value,
                               ...
                               str_info,
                               self.ctx)
            if self._show_tasks_skills_menu:
                text_height = self.viewport.height - 55
                rect = mj.MjrRect(5, text_height, 350, 50)
                mj.mjr_label(
                    rect,
                    mj.mjtFontScale.mjFONTSCALE_300.value,
                    f"Current Skill: {self.current_skill}",
                    0.1, 0.1, 0.1, 0.95,   # background
                    1.0, 1.0, 1.0,       # text
                    self.ctx
                )
                text_height = self.viewport.height - 105
                rect = mj.MjrRect(5, text_height, 350, 50)
                mj.mjr_label(
                    rect,
                    mj.mjtFontScale.mjFONTSCALE_300.value,
    ...
    def update_tasks_skills_menu(self, current_skill, success_count):
        self._show_tasks_skills_menu = True
